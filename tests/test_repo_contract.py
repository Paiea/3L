...
class RepoContractTests(unittest.TestCase):
    ...
    def test_manifest_owns_order_and_quality_state(self):
        ...
        self.assertTrue(all(r["published"] for r in records[:17]))
        self.assertTrue(all(not r["published"] for r in records[17:]))
    ...
    def test_reference_audio_is_public_and_library_first(self):
        ...
        self.assertTrue(all(audio["records"][f"r{i:03d}"]["status"] == "published" for i in range(1, 18)))
