...
> Durable whole-book truths. Canonical prose wins every conflict. Future routing below is authoritative pressure, not fixed chapter choreography.
...
Worldbuilding arrives through work, money, tools, contracts, institutions, property, travel, family, bodies, law, maintenance, food, Ranker labor, magic used practically, and ordinary dependence. Young Greg owns perception. Old Greg owns selection. Ithar interrupts only when the examination earns it.

3L spans decades. Time is a primary material of the book. Do not let progression, revenge, or magic development collapse years into stat jumps. Let bodies, families, work, money, relationships, institutions, and Greg's support architecture change because actual time passes.